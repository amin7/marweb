...
std::string getResetInfo() {
    ...
    switch (rst_info->reason) {
        ...
        case REASON_WDT_RST: /* hardware watch dog reset */
            info << "REASON_WDT_RST";
            break;
        case REASON_EXCEPTION_RST: /* exception reset, GPIO status wonâ€™t change */
            info << "REASON_EXCEPTION_RST";
            break;
        case REASON_SOFT_WDT_RST: /* software watch dog reset, GPIO status wonâ€™t change */
            info << "REASON_SOFT_WDT_RST";
            break;
        case REASON_SOFT_RESTART: /* software restart ,system_restart , GPIO status wonâ€™t change */
